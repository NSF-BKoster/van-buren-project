...
namespace Game
{
	...
	public class GameEngineApp : EngineApp
	{
        ...
        FileInfo textDatabase = new FileInfo(VirtualFileSystem.GetRealPathByVirtual("dialogs0.db3"));
		...
		protected override bool OnCreate()
		{
            ...
            //initialize texts
            Conversational.Initialize(textDatabase);
		...
		GameWindow CreateGameWindowByGameType( GameMap.GameTypes gameType )
		{
            ...
            //
            case GameMap.GameTypes.VanBuren:
                return new VBGameWindow();
