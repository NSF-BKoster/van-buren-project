...
namespace ProjectEntities
{
	...
	public class RTSCharacter : RTSUnit, GridBasedNavigationSystem.IOverrideObjectBehavior
	{
        ...
        public Vec3 MainBodyVelocity
        {
            get { return mainBodyVelocity; }
        }
		...
		public virtual void TickMove()
		{
			...
			//line movement to path[ 0 ]
			{
				...
				Vec2 dirStep = dirVector * ( MaxVelocity * TickDelta ); //VBCODE
